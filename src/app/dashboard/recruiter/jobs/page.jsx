...
const RecruiterJobs = async () => {
    ...
    return (
        <div className="p-6 max-w-7xl mx-auto space-y-4">
            <div className="flex flex-col gap-1 mb-8 space-y-2">
                <h2 className="text-2xl font-bold tracking-tight">Manage All Jobs</h2>
                <p className="text-sm text-gray-500 font-medium">View, update, and manage your current job postings.</p>
            </div>

            <Table aria-label="Company jobs management table" className="font-medium">
                                    ...
                                    <Table.Cell>
                                        <div className="relative flex items-center gap-2">
                                            ...
                                            <Tooltip content="Delete Job">
                                                <Button
                                                    className="border bg-red-500 border-red-200"
                                                    isIconOnly
                                                    size="sm"
                                                    variant="light"
                                                    color="danger"
